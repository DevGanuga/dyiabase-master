-- =============================================
-- 016: Create customers table (correct FK) + Add source to quotes
-- =============================================

-- 1. Create dyia_customers with correct UUID FK (if it doesn't exist)
...
-- RLS: anon key can SELECT own customers, service role bypasses RLS
DO $$ BEGIN
...
-- 2. Add source column to dyia_quotes for marketing funnel tracking
ALTER TABLE dyia_quotes ADD COLUMN IF NOT EXISTS source TEXT;
