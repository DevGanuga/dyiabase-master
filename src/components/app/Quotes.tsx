                ...
                <div className="flex gap-1">
                  ...
                  {quote.status === 'completed' && (
                    <button
                      ...
                      className="flex items-center gap-1 px-2 py-1 text-xs text-[var(--color-text-faint)] hover:text-amber-500 rounded-lg transition"
                  ...
                  {onEditQuote && (
                    <button
                      ...
                      className="flex items-center gap-1 px-2 py-1 text-xs text-[var(--color-text-faint)] hover:text-blue-500 rounded-lg transition"
                      title="Edit quote"
                    >
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 text-xs text-[var(--color-text-faint)] hover:text-orange-500 rounded-lg transition"
                    title="Download PDF"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 text-xs text-[var(--color-text-faint)] hover:text-red-500 rounded-lg transition"
                    title="Delete"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
