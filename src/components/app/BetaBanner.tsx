...
export function BetaBanner() {
  ...
  return (
    <div
      className={`relative border-b border-orange-500/20 bg-gradient-to-r from-orange-500/8 via-amber-500/6 to-orange-500/8 overflow-hidden transition-all duration-300 ${
